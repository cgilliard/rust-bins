...
typedef char sizeof_assert_ZRG2cG11unwind0_0_09libunwind18__Unwind_Exception0g[ (sizeof(struct s_ZRG2cG11unwind0_0_09libunwind18__Unwind_Exception0g) == 64) ? 1 : -1 ];
...

{
	...
	ZRG2cF10alloc0_0_05alloc15___rust_dealloc0g( var2, 0x50ull, 0x8ull );
...

{
	...
	for(unsigned int i = 0; i < 6; i ++)
		var2.DATA[i] = 0x0ull;	// _2 = SizedArray(0x0 usize; 6)
