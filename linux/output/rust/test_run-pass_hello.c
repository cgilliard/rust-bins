...
;
// EXTERN extern "Rust" ::"std-0_0_0_H19000"::io::stdio::_print<'static,>
...
union u_static_ZRG1cD3binG7lifted00g{ t_ZRTA0G2cE9core0_0_03fmt10ArgumentV10g val; uintptr_t raw[0]; } ZRG1cD3binG7lifted00g;	// static ::"bin#"::lifted#0 : [::"core-0_0_0"::fmt::ArgumentV1<'static,>/*S*/; 0]
...

{
	...
	var4 = make_sliceptr(&ZRG1cD3binG7lifted00g.val, 0x0ull);	// _4 = MakeDst(&::"bin#"::lifted#0, 0x0 usize)
	...
	ZRG3cD15std0_0_0_H190002io5stdio6_print0g( var1 );
	// ^ Call( _0 = ::"std-0_0_0_H19000"::io::stdio::_print<'static,>( _1, ), bb1, bb2)
	/* ZST assign */
	return ;
	// ^ Return
